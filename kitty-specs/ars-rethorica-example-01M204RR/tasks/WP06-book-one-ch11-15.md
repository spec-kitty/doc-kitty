...
create_intent:
- example/docs/rhetoric/book-one/chapter-11.md
- example/docs/rhetoric/book-one/chapter-12.md
- example/docs/rhetoric/book-one/chapter-13.md
- example/docs/rhetoric/book-one/chapter-14.md
- example/docs/rhetoric/book-one/chapter-15.md
...
Convert Book I chapters 11–15 of Aristotle's *Rhetoric* into doc-kitty showcase pages. Read `../spec.md` (FR-001/005/006/007/011), `../contracts/conversion-transform.md` (**authoritative rules**), `../research.md` (D2, D5), and each source file under `../source-vendor/`. Parallel with WP04/WP05.
...
### T025 — Convert chapter 11
Convert `../source-vendor/book1chapter11.md` → `example/docs/rhetoric/book-one/chapter-11.md` per `../contracts/conversion-transform.md`. Prev/next nav links root-absolute. `mark-status` when done.

### T026 — Convert chapter 12
Convert `../source-vendor/book1chapter12.md` → `example/docs/rhetoric/book-one/chapter-12.md` per `../contracts/conversion-transform.md`. Prev/next nav links root-absolute. `mark-status` when done.

### T027 — Convert chapter 13
Convert `../source-vendor/book1chapter13.md` → `example/docs/rhetoric/book-one/chapter-13.md` per `../contracts/conversion-transform.md`. Prev/next nav links root-absolute. `mark-status` when done.

### T028 — Convert chapter 14
Convert `../source-vendor/book1chapter14.md` → `example/docs/rhetoric/book-one/chapter-14.md` per `../contracts/conversion-transform.md`. Prev/next nav links root-absolute. `mark-status` when done.

### T029 — Convert chapter 15
Convert `../source-vendor/book1chapter15.md` → `example/docs/rhetoric/book-one/chapter-15.md` per `../contracts/conversion-transform.md`. Prev/next nav links root-absolute. `mark-status` when done.
...
- `spec-kitty agent tasks mark-status T025 T026 T027 T028 T029 --status done`.
