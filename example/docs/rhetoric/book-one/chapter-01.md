---
title: "Chapter 1: What is the point of Rhetoric?"
description: "Aristotle defines rhetoric as the counterpart of dialectic and argues that a systematic art of proof, not appeals to emotion, is its true business."
doc_status: active
updated: 2026-09-08
type: Reference
kind: Explanation
tags: [rhetoric, book-one]
glossary_context: rhetoric
# The chapter's many short footnote/section headings make Starlight's on-this-page
# nav a tightly packed list whose links fall below the WCAG 2.2 target-size (2.5.8)
# minimum — an unrelated theme-chrome issue this prose page should not carry (the
# glossary and diagram demonstrators suppress their TOC for the same reason). The
# footnote apparatus and the {blurb} callout in the body are unaffected; the table
# of contents is suppressed here so the axe lane covers the reader-facing content.
tableOfContents: false
external_references:
  - type: biblio
    id: freese-rhetoric-1926
---
...
[the types of rhetoric](/rhetoric/book-one/chapter-03/#types-of-rhetoric), Aristotle assumes the reader is already vaguely familiar with these terms.
see [the glossary](/glossary/rhetoric/)
...
← [Preamble](/rhetoric/preamble/) | [Chapter 2: Argumentation techniques](/rhetoric/book-one/chapter-02/) →

This page is a CC-BY-SA-4.0 derivative — see [About and license](/rhetoric/about-and-license/) for full attribution.
