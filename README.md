...
> **Status:** early scaffold. The structure is being reviewed before the build
> toolchain is wired up. See [`docs/`](./docs) for the design and the
> convention spec.
...
| [`.github/`](./.github) | Generic CI: lint + build + test, and a Pages deploy for the example. |
...
## Quickstart (once the build is wired up)
